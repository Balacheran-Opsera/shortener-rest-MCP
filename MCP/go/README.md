# Shorten.REST API Documentation MCP Server

This MCP (Model Content Protocol) server provides access to Shorten.REST API Documentation API functionality through HTTP, HTTPS, and STDIO transport modes.
